...
Usage examples:
  ...
  ./manage_runs.py --submit           # resubmit missing/incomplete runs via 2D_basic_mpi.sh
...
def main() -> None:
    ...
    parser.add_argument("--job-script", default="2D_basic_mpi.sh", help="PBS script used to run ap.out.")
